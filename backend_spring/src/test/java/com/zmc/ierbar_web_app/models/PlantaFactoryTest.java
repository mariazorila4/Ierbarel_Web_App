...
public class PlantaFactoryTest {
    ...
    public void testCreazaFloare(){
        ...
        Planta trandafir=factory.creazaPlanta(CategoriePlanta.FLOARE,1,"trandafir","Rosa","Rosaceae","O floare parfumata",0.5f,"Primavara",null,TipPlanta.ORNAMENTALA ,10,"rosu",null,null,false,false,null,false);
    ...
    public void testCreazaArbore(){
        PlantaFactory factory=new PlantaFactory();
        Planta stejar=factory.creazaPlanta(CategoriePlanta.ARBORE,2,"stejar","Quercus","Fagaceae","Un copac mare",20.0f,"Primavara",null,TipPlanta.ORNAMENTALA ,0,null,"Rotunda","Lobata",true,false,null,false);
    ...
    public void testCreazaArbust(){
        PlantaFactory factory=new PlantaFactory();
        Planta maces=factory.creazaPlanta(CategoriePlanta.ARBUST,3,"maces","Rosa canina","Rosaceae","Un arbust cu fructe",1.5f,"Primavara",null,TipPlanta.COMESTIBILA ,0,null,null,null,false,true,null,false);
    ...
    public void testCreazaIerburi(){
        PlantaFactory factory=new PlantaFactory();
        Planta busuioc=factory.creazaPlanta(CategoriePlanta.IERBURI,4,"busuioc","Ocimum basilicum","Lamiaceae","O planta aromatica",0.3f,"Vara",null,TipPlanta.AROMATICA ,0,null,null,null,false,false,"Tulpina moale",true);

        Assertions.assertNotNull(busuioc, "Planta creata nu trebuie sa fie null");
        Assertions.assertTrue(busuioc instanceof com.zmc.ierbar_web_app.models.simple_factory.Ierburi, "Planta creata trebuie sa fie o instanta a clasei Ierburi");
    ...
    public void testCreazaPlantaInvalida(){
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            factory.creazaPlanta(null,5,"planta_invalida","N/A","N/A","N/A",0.0f,"N/A",null,TipPlanta.ORNAMENTALA ,0,null,null,null,false,false,null,false);
