...
public class PlantaController {
    ...
    // ==========================================
    // 📷 SCANARE VIZUALĂ DIRECTĂ CU GEMINI VISION
    // ==========================================
    ...
    public ResponseEntity<?> scaneazaImagineYOLO(@RequestParam("file") MultipartFile file) {
        try {
            ...
            // Apelăm Gemini Vision API direct
            Map<String, String> detaliiPlanta = agentAIService.scaneazaPlantaCuGeminiVision(file);
