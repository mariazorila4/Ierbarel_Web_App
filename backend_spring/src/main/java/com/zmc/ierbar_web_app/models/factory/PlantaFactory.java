...
public class PlantaFactory {
    public Planta creazaPlanta(CategoriePlanta categorie_planta, 
                                      ...
                                      String familie, String descriere, String habitat, float inaltime_maxima, 
        ...
        switch (categorie_planta) {
            case FLOARE:
                return new Floare(id, nume_uzual, denumire_stiintifica, familie, descriere, habitat,inaltime_maxima, perioada_inflorire,
                                poate_fi_uscata, ciclu_de_viata, tip_planta, locatie, imagine_url, categorie_planta, numar_petale, culoare);

            
            case ARBORE:
                return new Arbore(id, nume_uzual, denumire_stiintifica, familie, descriere, habitat, inaltime_maxima, perioada_inflorire, 
                                 poate_fi_uscata, ciclu_de_viata, tip_planta, locatie, imagine_url, categorie_planta, tip_coroana, tip_frunza, pom_fructifer);
            
            case ARBUST:
                return new Arbust(id, nume_uzual, denumire_stiintifica, familie, descriere, habitat, inaltime_maxima, perioada_inflorire, 
                    poate_fi_uscata, ciclu_de_viata, tip_planta, locatie, imagine_url, categorie_planta, produce_fructe);
            
            case IERBURI:
                return new Ierburi(id, nume_uzual, denumire_stiintifica, familie, descriere, habitat, inaltime_maxima, perioada_inflorire, 
